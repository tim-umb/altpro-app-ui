...
import { EntityFormR1Props } from 'src/types';

const EntityForm: any = styled('div')(({ theme }: any) => ({
...
function EntityFormR1(props: EntityFormR1Props): JSX.Element {
  return (
    <EntityForm className={props.className}>
      <Title>
